...
DCX_WINDOW :: u32(0x00000001)
DCX_CACHE :: u32(0x00000002)
RGN_AND :: 1
RGN_DIFF :: 4
RGN_COPY :: 5
DCX_INTERSECTRGN :: u32(0x00000080)
ONE_HRGN : HRGN : cast(HRGN)(cast(uintptr)1)
...
NM_FIRST  :: ~u32(0)  //~u64(0) - 1 // (0U - 0U)

// NM_OUTOFMEMORY :: (NM_FIRST-1)
NM_CLICK :: (NM_FIRST - 1) // 4294967294
